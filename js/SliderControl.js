L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this.timestampContainer.style.cssText = "width:200px; margin-top:3px; background-color:#0074d9; font-size: 14px; text-align:center; border-radius:10px;display:none;";
